...
namespace ChuangShiProfile
{
    public partial class FormMain : Form
    {
        ...
        public class FansRankJson // 粉丝排行榜JSON实体类
        {
            public long uid { get; }
        ...
        private Assembly CurrentDomain_AssemblyResolve(object sender, ResolveEventArgs args) // 用于自动关联资源文件中的dll文件（dll文件是项目中使用的第三方库），以让生成exe无需附带dll文件即可正常运行
        {
